...
import { Store, Send, CheckCircle2, Clock, AlertCircle, Loader2, ArrowRight } from "lucide-react";
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400">Launch your store and reach millions of customers.</p>
            </div>
          </div>
          ...
          <AnimatePresence mode="wait">
            {status === "approved" ? (
              ...
              >
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">You're a Seller!</h2>
                <p className="text-slate-500 dark:text-slate-400 mb-8 px-4">
                  Your application for <span className="font-bold text-blue-600 dark:text-blue-400">"{user?.vendorProfile?.storeName}"</span> has been approved.
                </p>
                <button 
              ...
              >
                ...
                <p className="text-slate-500 dark:text-slate-400 mb-6 px-4">
                  We've received your application and it's currently being reviewed by our team. You'll be notified once approved.
                </p>
                <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800 text-left">
                  <p className="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2">Reviewing details for:</p>
                  <p className="text-lg font-bold text-slate-800 dark:text-slate-200">{user?.vendorProfile?.storeName || formData.storeName}</p>
                </div>
              </motion.div>
            ) : (
              <motion.form 
              ...
              >
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1">Store Description</label>
                  <textarea 
                    required
                    rows={4}
