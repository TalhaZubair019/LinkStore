      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
        <main className="flex-1 p-4 lg:p-8 pt-6 lg:pt-8">
            ...
            <div className="flex items-center gap-4 shrink-0">
              {d.user?.vendorProfile?.storeSlug && (
                <Link
                  ...
                  className="flex items-center gap-2 px-3 py-2 lg:px-4 lg:py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-xl text-xs lg:text-sm font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all shadow-sm"
                >
                  <Store size={18} />
          ...
          <DashboardHeader
            ...
            visitStoreUrl={
              d.user?.vendorProfile?.storeSlug
                ? `/vendor/view/${d.user.vendorProfile.storeSlug}`
                : undefined
            }
          />

          {(d.stats?.outstandingCommission ?? 0) > 0 && (
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">
                      Action Required: Settle Commission
                    </h3>
                    <p className="text-slate-600 dark:text-slate-400 mt-1 max-w-md">
                      You have an outstanding COD commission of{" "}
          ...
          {d.activeTab === "reviews" && (
            <ReviewsTabContent
              ...
              reviews={(d.stats.reviews || []).filter(
