    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="h-48 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-b-[40px] relative mb-16">
        ...
        <div className="absolute bottom-4 right-12 flex gap-3">
          ...
          <button className="px-6 py-2.5 bg-indigo-500 rounded-xl text-white font-bold hover:shadow-lg transition-all active:scale-95 shadow-indigo-500/50">
            + Follow Store
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 mb-8">
        <div className="flex gap-4 overflow-x-auto hide-scrollbar pb-2">
          {[1, 2, 3].map((v) => (
             <div key={v} className="min-w-[280px] bg-indigo-50 border border-indigo-200 rounded-xl p-4 flex items-center justify-between border-dashed shrink-0">
               <div>
                 <p className="text-xl font-black text-indigo-600">10% OFF</p>
                 <p className="text-xs text-indigo-800 font-medium">Min. Spend $50.00</p>
                 <p className="text-[10px] text-gray-500 mt-1">Valid till 30 Dec</p>
               </div>
               <button className="bg-indigo-600 text-white text-xs font-bold px-4 py-2 rounded-full hover:bg-indigo-700 shadow-sm">
                 Collect
               </button>
             </div>
          ))}
