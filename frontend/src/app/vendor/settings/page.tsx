  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 pb-20">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1 font-medium">Manage your marketplace presence and financials</p>
      </div>

      <div className="grid gap-8">
        {/* Stripe Connect Section */}
        <section className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 p-8 md:p-10 shadow-xl shadow-slate-200/50 dark:shadow-none transition-all">
