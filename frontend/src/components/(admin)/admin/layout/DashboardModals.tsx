...
import AddAdminModal from "@/components/(admin)/admin/modals/AddAdminModal";
import CategoryModal from "@/components/(admin)/admin/modals/CategoryModal";
import UserModal from "@/components/(admin)/admin/modals/UserModal";
import OrderModal from "@/components/(admin)/admin/modals/OrderModal";
import DeleteConfirmationModal from "@/components/(admin)/admin/modals/DeleteConfirmationModal";
import CancelOrderConfirmModal from "@/components/(admin)/admin/modals/CancelOrderConfirmModal";
import StockAdjustmentModal from "@/components/(admin)/admin/modals/StockAdjustmentModal";
import WarehouseModal from "@/components/(admin)/admin/modals/WarehouseModal";
import { Order, UserData, DashboardStats } from "@/app/(admin)/admin/types";
...
const DashboardModals: React.FC<DashboardModalsProps> = ({
  ...
  return (
    <>
      {isAddAdminModalOpen !== undefined && setIsAddAdminModalOpen && (
        <AddAdminModal
      ...
      {isCategoryModalOpen !== undefined && setIsCategoryModalOpen && (
        <CategoryModal
      ...
      {selectedUser !== undefined && setSelectedUser && (
        <UserModal
      ...
      {selectedOrder !== undefined && setSelectedOrder && (
        <OrderModal
      ...
      {isWarehouseModalOpen !== undefined && setIsWarehouseModalOpen && (
        <WarehouseModal
