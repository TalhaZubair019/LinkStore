...
const VendorsStatCard = ({ totalVendors, pendingVendors }: VendorsStatCardProps) => {
  ...
  return (
    <div className="relative group cursor-pointer w-full h-full">
      {/* Dynamic Glow Aura */}
      <div className="absolute -inset-1 bg-linear-to-br from-orange-600 to-amber-600 rounded-[2.5rem] opacity-0 blur-xl group-hover:opacity-15 transition-all duration-1000" />
      ...
      <div className="relative h-full p-8 rounded-[2.5rem] bg-white dark:bg-[#11141b] border border-slate-100 dark:border-white/5 shadow-xl transition-all duration-500 overflow-hidden flex flex-col justify-between group-hover:-translate-y-1.5 group-hover:shadow-2xl">
        ...
        <div className="absolute -top-32 -right-32 w-72 h-72 bg-orange-600/10 rounded-full blur-[100px] group-hover:bg-orange-600/15 duration-700" />
        <div className="absolute -bottom-32 -left-32 w-72 h-72 bg-amber-600/5 rounded-full blur-[100px] group-hover:bg-amber-600/10 duration-700" />
        ...
        <div className="flex items-start justify-between relative z-10 w-full gap-4 mb-6">
          ...
          <div className="relative">
            {/* Pulsing Icon Glow */}
            <div className="absolute inset-0 bg-linear-to-br from-orange-500 to-amber-600 rounded-3xl blur-md opacity-40 group-hover:opacity-70 transition-opacity duration-500" />
            <div className="p-4.5 rounded-3xl bg-linear-to-br from-orange-500 to-amber-600 shadow-2xl relative overflow-hidden group-hover:scale-105 transition-all duration-500 ease-out shrink-0 ring-1 ring-white/20">
        ...
        <div className="relative z-10 pt-6 space-y-3">
          ...
          <div className="h-1.5 w-full bg-slate-100 dark:bg-white/5 rounded-full overflow-hidden shadow-inner flex">
            <div
              className="h-full bg-linear-to-r from-emerald-500 to-teal-500 transition-all duration-1000 ease-out shadow-[0_0_12px_rgba(16,185,129,0.3)]"
              style={{ width: `${approvedRate}%` }}
            />
            <div
              className="h-full bg-linear-to-r from-orange-400 to-orange-600 transition-all duration-1000 ease-out shadow-[0_0_12px_rgba(249,115,22,0.3)]"
